 ...
 */
final class Version20220314202758 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE movie CHANGE title title VARCHAR(128) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(2048) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
